 ...
 * Date:     2013-1-26 下午4:50:33 <br/>
 * @author   maple
 * @version  
 * @since    JDK 1.6
 * @see 	 
 */
public class FavoriteAdapter extends AbstractAdapter<HotelInfo> {

    public FavoriteAdapter(List<HotelInfo> data, Context context) {
        super(data, context);
    ...
    public View createView(int position, View convertView, ViewGroup parent, LayoutInflater inflater) {
        ...
        holder.nameView.setText(info.getName() == null ? "" : info.getName());
        holder.addressView.setText(info.getAddress() == null ? "" : info.getAddress());
        return convertView;
    }
